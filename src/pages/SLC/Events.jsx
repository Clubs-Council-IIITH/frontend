...
import { ADMIN_SLC_PENDING_EVENTS, ADMIN_APPROVED_EVENTS } from "queries/events";
                ...
                <Box mb={3}>
                    ...
                    <Page
                        ...
                        empty={
                            ...
                            !pendingEventsData?.adminSlcPendingEvents?.length
                        }
                    >
                        <Grid container spacing={2} mb={2}>
                            {pendingEventsLoading
                                ...
                                : pendingEventsData?.adminSlcPendingEvents?.map((event, idx) => (
                                      <Grid item md={4} lg={3} key={idx}>
